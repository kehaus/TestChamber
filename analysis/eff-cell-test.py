...
V = np.array([0.1,0.2,0.3,0.5,0.8,1.0,1.2,1.5,1.7,1.9,2.1,2.6])   # [V]
I = np.array([0.5,1.0,1.5,2.5,4.0,5.0,6.0,7.0,8.0,9.0,10,12])     # [A]
T = np.array([23,26,31,44,84,132,180,233,296,350,407, 506])       # [°C]
